...
public class QsColors extends SettingsPreferenceFragment  implements Preference.OnPreferenceChangeListener {
 ...
 @Override
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.custom_qs_colors);
 ...
 @Override
    ...
    private void resetToDefault() {
        ...
        alertDialog.setTitle(R.string.qs_colors_reset_title);
        alertDialog.setMessage(R.string.qs_colors_reset_message);
